  ...
  <div className="courses" style={{ ...(!menuCollapse && { width: '77%', marginLeft: '300px',  transition: "0.3s"}),
    ...(menuCollapse && { width: '90%', marginLeft: '100px',  transition: "0.3s"})
        ...
        <div className="container" >
          <h2 className="List_student_heading">List of Teachers</h2>
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        <tr className="student_theard" >
          ...
          <td className="Student_list_table_tead">Back end</td>
          <td className="Student_list_table_tead">Group-14 , Group-15 , Group-16</td>
